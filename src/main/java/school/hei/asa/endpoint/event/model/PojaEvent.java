...
import static school.hei.asa.endpoint.event.EventStack.EVENT_STACK_1;
...
public abstract class PojaEvent implements Serializable {
  ...
  public String getEventSource() {
    if (getEventStack().equals(EVENT_STACK_1)) return "school.hei.asa.event1";
    return "school.hei.asa.event2";
  }
}
